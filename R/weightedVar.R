...
weightedVar <- function(x, w = NULL, idxs = NULL, na.rm = FALSE,
  ...
  if (use_0.14.2) {
    .Deprecated(msg = "weightedVar(..., method = \"0.14.2\") should not be used since it uses an incorrect degree-of-freedom term. It was supported only for very rare backward compatible reasons. It will be defunct in a future version of matrixStats.")
  }
