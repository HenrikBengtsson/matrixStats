/***********************************************************************
 ...
 ARGUMENTS_LIST:
  double *x, R_xlen_t nrow, R_xlen_t ncol, void *rows, R_xlen_t nrows, int rowsType, void *cols, R_xlen_t ncols, int colsType, int narm, int hasna, R_xlen_t byrow, double *ans, int cores
 ***********************************************************************/
#include <pthread.h>
#include <stdint.h>
#include "types.h"
