...
*   checking tests ...
    ...
    ...
          █
       1. └─base::Map(f = ms_f, matrix_list, rows = rows_list, cols = cols_list) test_row_and_col_functions.R:62:4
       2.   └─base::mapply(FUN = f, ..., SIMPLIFY = FALSE)
       3.     └─(function (x, rows = NULL, cols = NULL, ties.method = c("max", ...
       4.       └─matrixStats:::ties_method_missing()
       5.         └─base:::action(...)
      
      [ FAIL 4 | WARN 0 | SKIP 0 | PASS 14290 ]
      Error: Test failures
      Execution halted
    ```
...
*   checking examples ... ERROR
    ```
    Running examples in ‘fishpond-Ex.R’ failed
    The error most likely occurred in:
    ...
    Error: Please explicitly specify argument 'ties.method' when calling colRanks() and rowRanks() of matrixStats. This is because the current default ties.method="max" will eventually be updated to ties.method="average" in order to align with the default of base::rank()
    Execution halted
    ```
...
*   checking tests ...
    ...
    Last 50 lines of output:
       6.           └─base:::action(...)
      ── Error (test_interaction.R:24:3): matched samples interactions work ──────────
      Error: Please explicitly specify argument 'ties.method' when calling colRanks() and rowRanks() of matrixStats. This is because the current default ties.method="max" will eventually be updated to ties.method="average" in order to align with the default of base::rank()
      Backtrace:
          █
       1. └─fishpond::swish(...) test_interaction.R:24:2
       2.   └─fishpond:::swishInterxPair(...)
    ...
       1. └─fishpond::swish(y, x = "condition", quiet = TRUE) test_swish.R:65:2
       2.   └─fishpond:::swishTwoGroup(...)
       3.     └─fishpond:::getSamStat(infRepsArray, condition, returnRanks = TRUE)
       4.       └─matrixStats::rowRanks(...)
       5.         └─matrixStats:::ties_method_missing()
       6.           └─base:::action(...)
      
      [ FAIL 6 | WARN 0 | SKIP 3 | PASS 9 ]
      Error: Test failures
      Execution halted
    ```
...
*   checking tests ...
    ...
    ...
      ...
      Backtrace:
          █
       1. └─matrixStats::rowRanks(x = mat) test-api_compatibility.R:1305:8
       2.   └─matrixStats:::ties_method_missing()
       3.     └─base:::action(...)
...
*   checking tests ...
    ...
    Last 50 lines of output:
      Backtrace:
          █
       1. ├─testthat::expect_equal(colRanks(sp_mat), matrixStats::colRanks(mat)) test-functions.R:283:4
       2. │ └─testthat::quasi_label(enquo(expected), expected.label, arg = "expected")
       3. │   └─rlang::eval_bare(expr, quo_get_env(quo))
       4. └─matrixStats::colRanks(mat)
       5.   └─matrixStats:::ties_method_missing()
    ...
       1. ├─testthat::expect_equal(rowRanks(sp_mat), matrixStats::rowRanks(mat)) test-row_functions.R:191:2
       2. │ └─testthat::quasi_label(enquo(expected), expected.label, arg = "expected")
       3. │   └─rlang::eval_bare(expr, quo_get_env(quo))
       4. └─matrixStats::rowRanks(mat)
       5.   └─matrixStats:::ties_method_missing()
       6.     └─base:::action(...)
      
      [ FAIL 10 | WARN 0 | SKIP 21 | PASS 1704 ]
      Error: Test failures
      Execution halted
    ```
...
*   checking examples ... ERROR
    ...
    Error: BiocParallel errors
      ...
      first error: Please explicitly specify argument 'ties.method' when calling colRanks() and rowRanks() of matrixStats. This is because the current default ties.method="max" will eventually be updated to ties.method="average" in order to align with the default of base::rank()
    Execution halted
    ```
