...
*   checking examples ... ERROR
    ...
    Using temporary cache /scratch/352417.1.long.q/RtmpsGsq4b/BiocFileCache
    Error in .updateHubDB(hub_bfc, .class, url, proxy, localHub) : 
      Invalid Cache: sqlite file
      Hub has not been added to cache
      Run again with 'localHub=FALSE'
...
*   checking S3 generic/method consistency ... WARNING
    ...
    (R:32122): Gtk-WARNING **: 13:47:35.335: gtk_disable_setlocale() must be called before gtk_init()
...
*   checking replacement functions ... WARNING
    ...
    (R:32233): Gtk-WARNING **: 13:47:39.221: gtk_disable_setlocale() must be called before gtk_init()
...
*   checking for missing documentation entries ... WARNING
    ...
    (R:32688): Gtk-WARNING **: 13:47:58.378: gtk_disable_setlocale() must be called before gtk_init()
...
*   checking for code/documentation mismatches ... WARNING
    ...
    (R:32735): Gtk-WARNING **: 13:48:01.880: gtk_disable_setlocale() must be called before gtk_init()
    
    (R:32800): Gtk-WARNING **: 13:48:05.037: gtk_disable_setlocale() must be called before gtk_init()
    
    (R:32867): Gtk-WARNING **: 13:48:08.611: gtk_disable_setlocale() must be called before gtk_init()
    ```
...
*   checking dependencies in R code ... NOTE
    ...
    (R:32041): Gtk-WARNING **: 13:47:32.878: gtk_disable_setlocale() must be called before gtk_init()
    ```

*   checking foreign function calls ... NOTE
    ```
    
    (R:32288): Gtk-WARNING **: 13:47:41.961: gtk_disable_setlocale() must be called before gtk_init()
    See chapter ‘System and foreign language interfaces’ in the ‘Writing R
    Extensions’ manual.
    ```
...
*   checking R code for possible problems ... NOTE
    ...
    (R:32456): Gtk-WARNING **: 13:47:47.561: gtk_disable_setlocale() must be called before gtk_init()
...
*   checking Rd \usage sections ... NOTE
    ...
    (R:32961): Gtk-WARNING **: 13:48:12.112: gtk_disable_setlocale() must be called before gtk_init()
...
*   checking Rd \usage sections ... WARNING
    ...
    Undocumented arguments in documentation object 'GatingSet,flowSet,ANY-method'
      ‘x’
...
*   checking examples ... ERROR
    ...
    + "hsa04012"))
    No internet connection using 'localHub=TRUE'
    Using temporary cache /scratch/352417.1.long.q/RtmpKujKEq/BiocFileCache
    Error in .updateHubDB(hub_bfc, .class, url, proxy, localHub) : 
      Invalid Cache: sqlite file
      Hub has not been added to cache
      Run again with 'localHub=FALSE'
...
*   checking Rd cross-references ... WARNING
    ```
    Unknown package ‘RLumShiny’ in Rd xrefs
    ```
...
*   checking tests ...
    ```
    ...
      RUNIT TEST PROTOCOL -- Sun Feb 16 01:09:30 2020 
      *********************************************** 
...
*   checking R code for possible problems ... NOTE
    ```
    doubletThresholding: warning in legend("top", col = c("blue", "red",
      "darkgrey"), lty = c(1, 1, 1), lw = 2, legend = leg): partial
      argument match of 'lw' to 'lwd'
    doubletThresholding: warning in legend("top", col = c("blue", "blue",
      "red", "darkgrey"), lty = c(1, 2, 1, 1), lw = 2, legend = leg):
      partial argument match of 'lw' to 'lwd'
